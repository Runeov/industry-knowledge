# Evidence Index — Marking Guide Mapping

This file maps each marking-guide criterion for the Industry
Knowledge sprint simulation to the specific evidence in this
repository (or, where applicable, external evidence to attach in the
Moodle submission), and to the screenshot or artefact you should
...
|---|---|---|---|
| 1 | I have completed the questionnaire to provide my preferences for working in this project. | **External** — completed via the Noroff team sign-up form before the sprint. Not stored in this repo. | Screenshot of the submitted questionnaire / confirmation email, or a written confirmation in the Moodle submission text. |
| 2 | I have accepted my invitation to the GitHub team I was assigned to. | Repo access confirmed at <https://github.com/Runeov/industry-knowledge>; recorded in [team.md](team.md) and the [Sprint 1 planning notes](meeting-notes/sprint-1-planning.md). | Logged-in GitHub profile (`Runeov`) on the repo page. |
| 3 | I have met with my team to discuss next steps and sprint planning. | [Sprint 1 planning meeting notes](meeting-notes/sprint-1-planning.md) — Mon Apr 27, 09:00, agreed sprint goal and 4 cards. | The planning notes file rendered on GitHub. |
| 4 | I have attended or watched the Onboarding live session. | **External** — attended / watched on Microsoft Teams as part of the Noroff onboarding. Not stored in this repo. | Screenshot of attendance confirmation, MS Teams meeting record, or a written confirmation in the Moodle submission text. |
...
| 10 | I have made my team aware of any obstacles or roadblocks. | Blocker incident on [Wed Apr 29](meeting-notes/sprint-1-daily-updates.md#wed-apr-29-2026--day-3-mid-sprint-check-in--blocker) — mobile layout overlap reported same day on the Trello card and on Discussions; resolved by Thursday afternoon. | Trello card comment + GitHub Discussions post for the mobile-overlap blocker. |

## Retrospective

| # | Marking criterion (exact wording) | Evidence | Screenshot / artefact to capture |
|---|---|---|---|
| 11 | I have reflected on my own challenges and successes during the sprint. | [reflection.md](reflection.md) — first-person reflection from Rune, with the GitHub username / team / role header block at the top. | The reflection file rendered on GitHub, plus the Moodle text submission. |
| 12 | I have met with my team to reflect on the challenges and successes during the sprint. | [Retrospective notes](meeting-notes/sprint-1-retrospective.md) — Fri May 1, 15:00, sections "What went well", "What was challenging", "What we learned", "Action items for Sprint 2". | The retrospective file rendered on GitHub. |
| 13 | My team has provided feedback to the class group. | "[Feedback to the class group](meeting-notes/sprint-1-retrospective.md#feedback-to-the-class-group)" section in the retrospective + the retro summary post in the [communication log](meeting-notes/sprint-1-daily-updates.md#communication-log--github-discussions-snippets) (item 5). | The "Feedback to the class group" section in `sprint-1-retrospective.md` rendered on GitHub. |
...
- [ ] Screenshot: Trello board on Fri May 1 with all 4 cards in **Done**.
